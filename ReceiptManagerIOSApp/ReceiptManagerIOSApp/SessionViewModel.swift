...
final class SessionViewModel {
    ...
    // Authentication service used to perform sign-in/sign-out ops
    ...
    // Handles the sign in and provides an error if username/password is wrong
    ...
    // Google sign-in entry point from the UI
    ...
    // Observes the states of Firebase authentication
